...
\begin{tikzpicture}
  ...
  \draw[domain=0:2,smooth,variable=\x,blue] plot ({\x},{0.5*\x^2.5+1});
  \draw[domain=0:2,smooth,variable=\x,red] plot ({\x},{0.5*\x^2.5+2});
  \draw[domain=0:2,smooth,variable=\x,green] plot ({\x},{0.5*\x^2.5+3});

  \draw[domain=0:2.5,dashed,variable=\x,blue] plot ({\x},{0.5*\x^2.5+1});
  \draw[domain=0:2.5,dashed,variable=\x,red] plot ({\x},{0.5*\x^2.5+2});
  \draw[domain=0:2.5,dashed,variable=\x,green] plot ({\x},{0.5*\x^2.5+3});
  
  \draw[dashed] (2.8,0) -- (2.8,7);
  ...
  \fill (2.8, 0) circle (2pt) node[below] {$(1)$};
